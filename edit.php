...
<div id="main">
	...
	<table id="add-prd" border="0" cellpadding="0" cellspacing="0">
    	<tr>
        	<td><label>Product's name</label><br /><input type="text" name="name_product" value="<?php if(isset($_POST['name_product'])){echo $_POST['name_product'];}else{echo $arr['name_product'];}?>" /></td><?php if(isset($error_name_product)){echo $error_name_product;}?>
        </tr>
        <tr>
        	<td><label>Description photo</label><br /><input type="file" name="picture_product" /><input type="text"  disabled name="picture_product" value="<?php echo $arr['picture_product'];?>" /></td>
        </tr>
        <tr>
